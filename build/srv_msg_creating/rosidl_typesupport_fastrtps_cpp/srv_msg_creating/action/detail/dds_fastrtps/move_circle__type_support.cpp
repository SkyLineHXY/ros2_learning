...
#include "srv_msg_creating/action/detail/move_circle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const srv_msg_creating::action::MoveCircle_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  srv_msg_creating::action::MoveCircle_Goal & ros_message)
{
  // Member: enable
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = srv_msg_creating::action::MoveCircle_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::action::MoveCircle_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<srv_msg_creating::action::MoveCircle_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_srv_msg_creating
const rosidl_message_type_support_t *
get_message_type_support_handle<srv_msg_creating::action::MoveCircle_Goal>()
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_Goal)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_srv_msg_creating
cdr_serialize(
  const srv_msg_creating::action::MoveCircle_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: finish
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  srv_msg_creating::action::MoveCircle_Result & ros_message)
{
  // Member: finish
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = srv_msg_creating::action::MoveCircle_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::action::MoveCircle_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<srv_msg_creating::action::MoveCircle_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_Result)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_srv_msg_creating
cdr_serialize(
  const srv_msg_creating::action::MoveCircle_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: state
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  srv_msg_creating::action::MoveCircle_Feedback & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = srv_msg_creating::action::MoveCircle_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::action::MoveCircle_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<srv_msg_creating::action::MoveCircle_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_Feedback)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_Feedback__handle;
}
...
// functions for srv_msg_creating::action::MoveCircle_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_srv_msg_creating
cdr_serialize(
  const srv_msg_creating::action::MoveCircle_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  srv_msg_creating::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  srv_msg_creating::action::MoveCircle_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  srv_msg_creating::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    srv_msg_creating::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        srv_msg_creating::action::typesupport_fastrtps_cpp::max_serialized_size_MoveCircle_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = srv_msg_creating::action::MoveCircle_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::action::MoveCircle_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<srv_msg_creating::action::MoveCircle_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_SendGoal_Request)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_srv_msg_creating
cdr_serialize(
  const srv_msg_creating::action::MoveCircle_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  srv_msg_creating::action::MoveCircle_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = srv_msg_creating::action::MoveCircle_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::action::MoveCircle_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<srv_msg_creating::action::MoveCircle_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_SendGoal_Response)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_SendGoal_Response__handle;
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_SendGoal)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_srv_msg_creating
cdr_serialize(
  const srv_msg_creating::action::MoveCircle_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  srv_msg_creating::action::MoveCircle_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = srv_msg_creating::action::MoveCircle_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::action::MoveCircle_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<srv_msg_creating::action::MoveCircle_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_GetResult_Request)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for srv_msg_creating::action::MoveCircle_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_srv_msg_creating
cdr_serialize(
  const srv_msg_creating::action::MoveCircle_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  srv_msg_creating::action::MoveCircle_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        srv_msg_creating::action::typesupport_fastrtps_cpp::max_serialized_size_MoveCircle_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = srv_msg_creating::action::MoveCircle_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::action::MoveCircle_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<srv_msg_creating::action::MoveCircle_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_GetResult_Response)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_GetResult_Response__handle;
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_GetResult)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_GetResult__handle;
}
...
// functions for srv_msg_creating::action::MoveCircle_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_srv_msg_creating
cdr_serialize(
  const srv_msg_creating::action::MoveCircle_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  srv_msg_creating::action::MoveCircle_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        srv_msg_creating::action::typesupport_fastrtps_cpp::max_serialized_size_MoveCircle_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = srv_msg_creating::action::MoveCircle_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::action::MoveCircle_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<srv_msg_creating::action::MoveCircle_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srv_msg_creating, action, MoveCircle_FeedbackMessage)() {
  return &srv_msg_creating::action::typesupport_fastrtps_cpp::_MoveCircle_FeedbackMessage__handle;
}
