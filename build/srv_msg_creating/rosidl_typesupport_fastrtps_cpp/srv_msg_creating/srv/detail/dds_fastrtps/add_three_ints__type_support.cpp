...
#include "srv_msg_creating/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = srv_msg_creating::srv::AddThreeInts_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<srv_msg_creating::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  return &srv_msg_creating::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = srv_msg_creating::srv::AddThreeInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<srv_msg_creating::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &srv_msg_creating::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &srv_msg_creating::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
