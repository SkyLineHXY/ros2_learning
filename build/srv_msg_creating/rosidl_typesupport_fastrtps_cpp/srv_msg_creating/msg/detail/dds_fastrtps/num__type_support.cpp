...
#include "srv_msg_creating/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = srv_msg_creating::msg::Num;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const srv_msg_creating::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<srv_msg_creating::msg::Num *>(
    untyped_ros_message);
...
{
  return &srv_msg_creating::msg::typesupport_fastrtps_cpp::_Num__handle;
}
