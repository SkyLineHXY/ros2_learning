...
{
  new (message_memory) srv_msg_creating::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<srv_msg_creating::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[3] = {
  {
    ...
    offsetof(srv_msg_creating::msg::Num, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(srv_msg_creating::msg::Num, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(srv_msg_creating::msg::Num, c),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Num_message_members = {
  "srv_msg_creating::msg",  // message namespace
  "Num",  // message name
  3,  // number of fields
  sizeof(srv_msg_creating::msg::Num),
...
get_message_type_support_handle<srv_msg_creating::msg::Num>()
{
  return &::srv_msg_creating::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srv_msg_creating, msg, Num)() {
  return &::srv_msg_creating::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
